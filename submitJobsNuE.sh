...
sourceDir="/pnfs/icarus/scratch/users/msotgia/hitTuning/mc/gridBNBNuESearchSmall/"
...
export tarFile="hitTuningInstallBNBNuE.tar.gz"  # Tarball with code and dependencies
